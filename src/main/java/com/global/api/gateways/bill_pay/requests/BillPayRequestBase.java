...
public abstract class BillPayRequestBase {
    ...
    protected void buildClearTextCredit(Element parent, CreditCardData card, BigDecimal amountToCharge, BigDecimal feeAmount, EmvFallbackCondition condition, EmvLastChipRead lastRead, Address address) {
        boolean isEmvFallback = condition != null && condition.equals(EmvFallbackCondition.CHIP_READ_FAILURE);
    ...
    /// </summary>
    protected void validateTransaction(AuthorizationBuilder builder) throws ValidationException {
    ...
    protected void validateBills(List<Bill> bills) throws ValidationException {
        ArrayList<String> validationErrors = new ArrayList<>();
    ...
    protected void validateReversal(ManagementBuilder builder) throws ValidationException {
        ArrayList<String> validationErrors = new ArrayList<>();
    ...
    protected void validateLoadSecurePay(HostedPaymentData hostedPaymentData) throws ValidationException {
        ArrayList<String> validationErrors = new ArrayList<>();
